          ...
          <div className="relative" ref={userMenuRef}>
            {userLoading ? (
              ...
              <>
                ...
                {/* Dropdown Menu */}
                {showUserMenu && (
                  <div className="absolute right-0 top-full mt-2 w-64 bg-[#1a2332] border border-[#2a3441] rounded-lg shadow-xl z-[100] overflow-hidden">
                    {/* User Header */}
                    <div className="px-4 py-3 border-b border-[#2a3441]">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-full bg-[#f5c518] flex items-center justify-center overflow-hidden">
                          {user.user_metadata?.avatar_url ? (
                            <Image
                              src={user.user_metadata.avatar_url}
                              alt="Avatar"
                    ...
                    {/* Quick Stats */}
                    <div className="px-4 py-3 grid grid-cols-2 gap-2 border-b border-[#2a3441]">
                      <div className="bg-[#0f1729] rounded-lg px-3 py-2 text-center">
                        <div className="flex items-center justify-center gap-1.5 mb-0.5">
                          ...
                          <span className="text-white font-bold text-sm">{userStats.favoritesCount}</span>
                        </div>
                        <span className="text-gray-500 text-[10px] uppercase">Favorites</span>
                      </div>
                      <div className="bg-[#0f1729] rounded-lg px-3 py-2 text-center">
                        <div className="flex items-center justify-center gap-1.5 mb-0.5">
                          ...
                          <span className="text-white font-bold text-sm">{userStats.historyCount}</span>
                        </div>
                        <span className="text-gray-500 text-[10px] uppercase">Watched</span>
                      </div>
                    </div>
